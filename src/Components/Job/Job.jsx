...
const Job = ({job}) => {
  ...
  return (
    <div className=" border-[1px] border-[#E8E8E8] rounded-lg">
     <div className="p-7">
     <img className="w-[117px] h-[40px] mb-8" src={logo} alt="" />
      <p className="text-[#474747] text-2xl font-extrabold mb-2">{job_title}</p>
      <p className="text-[#757575] text-xl font-semibold mb-4">{company_name}</p>
      <div className="flex gap-4 mb-4">
        <button className="border-[1px] border-[#7E90FE] text-[#7E90FE] pt-[9px] pb-[9px] pr-[19px] pl-[19px] text-[16px] font-extrabold bg-transparent rounded-lg">{remote_or_onsite}</button>
        <button className="border-[1px] border-[#7E90FE] text-[#7E90FE] pt-[9px] pb-[9px] pr-[19px] pl-[19px] text-[16px] font-extrabold bg-transparent rounded-lg">Full Time</button>
      </div>
      <div className="flex gap-6 mb-6">
        ...
        <span className="text-[#757575] text-xl font-semibold">{location}</span>
        </p>
        <p className="flex">
          <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
