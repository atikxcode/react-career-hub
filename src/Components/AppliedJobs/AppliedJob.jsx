...
const AppliedJob = ({job}) => {
  ...
  return (
    <div className="border-[1px] border-[#E8E8E8] p-4 mb-8 rounded-lg">
      <div className='flex items-center'>
      <div>
      <img className="w-[240px] p-4" src={logo} alt="" />
      </div>

     <div className="flex justify-between w-full items-center">
     <div className='flex flex-col'>
      <h2 className="text-[#474747] text-[24px] font-extrabold mb-2">{job_title}</h2>
      <p className="text-[#757575] text-[24px] font-semibold mb-4">{company_name}</p>
      <div className='flex gap-[10px] mb-[25px]'>
        <button className="border-[1px] border-[#7E90FE] text-[#7E90FE] pt-[9px] pb-[9px] pr-[19px] pl-[19px] text-[16px] font-extrabold rounded-lg">{remote_or_onsite}</button>
        <button className="border-[1px] border-[#7E90FE] text-[#7E90FE] pt-[9px] pb-[9px] pr-[19px] pl-[19px] text-[16px] font-extrabold rounded-lg">Full Time</button>
      </div>
      ...
      <span className="text-[#757575] text-[20px] font-semibold">{location}</span>
      </p>
        <p className="flex items-center gap-1">
          <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <span className="text-[#757575] text-[20px] font-semibold">Salary: {salary}</span></p>
      </div>
      </div>

      <div className="">
        <button className="bg-gradient-to-r from-[#7E90FE] to-[#9873FF] pt-[10px] pb-[10px] pr-[20px] pl-[20px] rounded-[8px] text-white text-[20px] font-extrabold">View Details</button>
      </div>
     </div>
