...
const JobDetails = () => {
  ...
  return (
    <div className="container mx-auto my-10 flex flex-col items-center ">
        ...
        <h2 className="text-[#1A1919] text-[32px] font-extrabold mb-32">Job Details</h2>
        

        <div className="flex justify-between gap-4">
          
        <div className="w-[872px]">
            <p className="leading-[32px] text-[#757575] text-[16px] font-medium mb-6"><span className="text-[#1A1919] text-[16px] font-extrabold">Job Description:</span> {job.job_description}</p>
            <p className="leading-[32px] text-[#757575] text-[16px] font-medium mb-6"><span className="text-[#1A1919] text-[16px] font-extrabold">Job Responsibility:</span> {job.job_responsibility}</p>
            <p className="leading-[32px] text-[#757575] text-[16px] font-medium mb-6"><span className="text-[#1A1919] text-[16px] font-extrabold mb-4">Educational Requirements: </span> <br /> {job.educational_requirements}</p>
            <p className="leading-[32px] text-[#757575] text-[16px] font-medium mb-6"><span className="text-[#1A1919] text-[16px] font-extrabold mb-4">Experiences: </span> <br /> {job.experiences}</p>
        </div>
        ...
        <div className="flex flex-col ">
          ...
          <div className="flex flex-col bg-gradient-to-r from-[#7e90fe19] to-[#9873ff19] w-[424px] h-[461px] rounded-[8px] p-6 ">
          
          <p className="text-[#1A1919] text-[20px] font-extrabold mb-[24px]">Job Details</p>
          <hr />
          <p className="flex mt-[24px] gap-2 mb-4">
          ...
          <span className="text-[#474747] text-[20px] font-bold">Salary :</span>
          <span className="text-[#757575] text-[20px] font-medium">{job.salary} (per Month)</span>
          </p>
          ...
          <span className="text-[#474747] text-[20px] font-bold">Job Title :</span>
          <span className="text-[#757575] text-[20px] font-medium">{job.job_title}</span>
          </p>
          <p className="mb-6 text-[#1A1919] text-[20px] font-extrabold">Contact Information</p>
          <hr />

          <p className="flex gap-2 mt-6 mb-4">
            <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <span className="text-[#474747] text-[20px] font-bold">Phone:</span>
          <span className="text-[#757575] text-[20px] font-medium">{job.contact_information.phone}</span>
          </p>
          ...
          <span className="text-[#474747] text-[20px] font-bold">Email :</span>
          <span className="text-[#757575] text-[20px] font-medium">{job.contact_information.email}</span>
          </p>
          ...
          <span className="text-[#474747] text-[20px] font-bold">Address:</span>
          <span className="text-[#757575] text-[20px] font-medium">{job.contact_information.address}</span>
          </p>
          </div>
            <div>
        ...
        <button onClick={notify} className="bg-gradient-to-r from-[#7E90FE] to-[#9873FF] pt-[19px] pb-[19px] pr-[161px] pl-[161px] rounded-[8px] text-white text-[20px] font-extrabold">Apply Now</button>
        </div>
